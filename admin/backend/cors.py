...
BACKEND_HOST = os.getenv('BACKEND_HOST', '172.17.2.78')
...
FACE_RECOGNITION_HOST = os.getenv('FACE_RECOGNITION_HOST', '172.17.2.228')

# FACE_RECOGNITION_PORT: The port number for the face recognition system
FACE_RECOGNITION_PORT = int(os.getenv('FACE_RECOGNITION_PORT', 8090))
...
FACE_RECOGNITION_HOST = "172.17.2.228"

# FACE_RECOGNITION_PORT: The port number for the face recognition system
# Port 8000 is used for the main face recognition server
FACE_RECOGNITION_PORT = 8090
...
#    f"http://172.17.2.228:{FRONTEND_PORT}",           # Alternative localhost access
    f"http://{BACKEND_HOST}:{BACKEND_PORT}",       # Backend self-access (if needed)
#    f"http://172.17.2.228:{BACKEND_PORT}"             # Alternative backend access (if needed)
]
